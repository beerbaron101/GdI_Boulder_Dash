...
public class MainMenuState extends BasicGameState {
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
    	...
    	/* Optionen-Entitaet */
    	Entity opt_Entity = new Entity("Optionen");
    	
    	// Setze Position und Bildkomponente
    	opt_Entity.setPosition(new Vector2f(218, 390));
    	opt_Entity.setScale(0.28f);
    	opt_Entity.addComponent(new ImageRenderComponent(new Image("assets/entry.png")));
    	
    	// Erstelle das Ausloese-Event und die zugehoerige Action
    	ANDEvent mainEvents_opt = new ANDEvent(new MouseEnteredEvent(), new MouseClickedEvent());
    	Action opt_Action = new ChangeStateInitAction(Launch.OPTIONS_STATE);
    	mainEvents_opt.addAction(opt_Action);
    	opt_Entity.addComponent(mainEvents_opt);
    	
    	// Fuege die Entity zum StateBasedEntityManager hinzu
    	entityManager.addEntity(this.stateID, opt_Entity);
